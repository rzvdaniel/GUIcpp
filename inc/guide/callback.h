...
#if defined(__LINUX__) || (defined(__WIN32__) && defined(__GNUC__)) || defined(__GNUC__)
	typedef void (*PFunc)();
#endif
...
makeFunctor(CBFunctor0 *,const Callee &c,TRT (CallType::* RHCB_CONST_REF f)()const)
	{
...
makeFunctor(CBFunctor0 *,Callee &c,
	TRT (CallType::* RHCB_CONST_REF f)())
	{
