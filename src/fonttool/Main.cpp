/**
	Code used to build the tool can be found at 	http://wiki.gamedev.net/index.php/OpenGL:Tutorials:Font_System
	and it has the copyright specified by its owners.
*/
