...
//  05-Nov-2003   rzv    created
//-------------------------------------------------------------------
void TTest2::Create(TComponent* AOwner, const TRect& Rect, bool HasCaption)
{	
	TForm::Create(AOwner, Rect, HasCaption);
	
	SetCaption("Radio button");

	// Group box for the radio buttons
	GroupBox1 = new TGroupBox;
	GroupBox1->Create(this, TRect(10, 40, GetWidth() - 20, 120));
	GroupBox1->SetColor(clGray);
	GroupBox1->SetCaption("Group box 1");

	// An offset to help when positioning the buttons
	int Offset = 32;

	// Radio buttons
	RadioBtn1 = new TRadioBtn;
	RadioBtn1->Create(this, TRect(16, Offset, 14, 14));
	...
	Disable1->Create(this, TRect(GroupBox1->GetWidth() - 80, GroupBox1->GetHeight()/2 - 16, 64, 0));
	Disable1->SetCaption("Disable");
	Disable1->SetParent(GroupBox1);
	Disable1->FOnClick = makeFunctor((TNotifyEvent*)0,*this, &TTest2::OnDisable1Click);
	
	// Group box for the check buttons
	GroupBox2 = new TGroupBox;
	GroupBox2->Create(this, TRect(10, 200, GetWidth() - 20, 120));
	GroupBox2->SetColor(clGray);
	...
	CheckBtn1->Create(this, TRect(16, Offset, 14, 14));
	...
	CheckBtn2->Create(this, TRect(16, Offset, 14, 14));
	...
	CheckBtn3->Create(this, TRect(16, Offset, 14, 14));
	CheckBtn3->SetCaption("This is ugly.");
	CheckBtn3->SetParent(GroupBox2);
	
	// Disable2 button
	Disable2 = new TButton;
	Disable2->Create(this, TRect(GroupBox2->GetWidth() - 80, GroupBox2->GetHeight()/2 - 16, 64, 0));
	Disable2->SetCaption("Disable");
	Disable2->SetParent(GroupBox2);
	Disable2->FOnClick = makeFunctor((TNotifyEvent*)0,*this, &TTest2::OnDisable2Click);
...
//-------------------------------------------------------------------
void TTest2::OnDisable1Click(void)
{
...
//  10-Sep-2003   rzv    created
//-------------------------------------------------------------------
void TTest2::OnDisable2Click(void)
{
